...
// ROUTES FOR SPRINT 51


router.post('/sprint51/singles/readytomove/confirm-answer', function (req, res) {
...
router.post('/sprint51/couples/readytomove/confirm-answer', function (req, res) {
...
router.post('/sprint51/couples/nomoreaction/confirm-answer', function (req, res) {
...
router.post('/sprint51/couples/cancel/confirm-answer', function (req, res) {
...
router.post('/sprint51/singles/cancel/confirm-answer', function (req, res) {
...
router.post('/sprint51/couples/pauseexclude/confirm-answer', function (req, res) {
...
router.post('/sprint51/singles/pauseexclude/confirm-answer', function (req, res) {
...
router.post('/sprint51/couples/eligibility/confirm-answer', function (req, res) {
